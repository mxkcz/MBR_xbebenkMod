...
##  Mod Info:
- These are my xbeMOD modifications, xbeMOD is based on official MyBotRun v7.9.9
...
- Use AutoIt v.3.3.18 [Download here](https://www.autoitscript.com/site/autoit/downloads/)
- Tested only with Bluestacks5 v.5.22.125.1001
  ```ps
  choco install bluestacks --version=5.22.125.1001
  ``` 
...
- CSVMod CSV Creation Guide - Help/CSVMod_GUIDE.md
