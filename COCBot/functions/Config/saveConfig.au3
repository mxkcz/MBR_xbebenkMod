...
Func SaveConfig_600_28_DB()
	...
	_Ini_Add("search", "chkBattleSearchCamps", $g_abSearchCampsEnable[$Battle] ? 1 : 0)
	_Ini_Add("search", "DBEnableAfterArmyCamps", $g_aiSearchCampsPct[$Battle])
	_Ini_Add("search", "chkBattleCastleWait", $g_abSearchCastleWaitEnable[$Battle] ? 1 : 0)
	; Search - Filters
	_Ini_Add("search", "DBMeetGE", $g_aiFilterMeetGE[$Battle])
	_Ini_Add("search", "DBsearchGold", $g_aiFilterMinGold[$Battle])
	_Ini_Add("search", "DBsearchElixir", $g_aiFilterMinElixir[$Battle])
	_Ini_Add("search", "DBsearchGoldPlusElixir", $g_aiFilterMinGoldPlusElixir[$Battle])
	_Ini_Add("search", "DBMeetDE", $g_abFilterMeetDEEnable[$Battle] ? 1 : 0)
	_Ini_Add("search", "DBsearchDark", $g_aiFilterMeetDEMin[$Battle])
	_Ini_Add("search", "DBMeetTH", $g_abFilterMeetTH[$Battle] ? 1 : 0)
	_Ini_Add("search", "DBTHLevel", $g_aiFilterMeetTHMin[$Battle])
	_Ini_Add("search", "DBMeetTHO", $g_abFilterMeetTHOutsideEnable[$Battle] ? 1 : 0)

	_Ini_Add("search", "DBMeetDeadEagle", $g_bChkDeadEagle ? 1 : 0)
	_Ini_Add("search", "DBMeetDeadEagleSearch", $g_iDeadEagleSearch)

	_Ini_Add("search", "DBCheckMortar", $g_abFilterMaxMortarEnable[$Battle] ? 1 : 0)
	_Ini_Add("search", "DBCheckWizTower", $g_abFilterMaxWizTowerEnable[$Battle] ? 1 : 0)
	_Ini_Add("search", "DBCheckAirDefense", $g_abFilterMaxAirDefenseEnable[$Battle] ? 1 : 0)
	_Ini_Add("search", "DBCheckXBow", $g_abFilterMaxXBowEnable[$Battle] ? 1 : 0)
	_Ini_Add("search", "DBCheckInferno", $g_abFilterMaxInfernoEnable[$Battle] ? 1 : 0)
	_Ini_Add("search", "DBCheckEagle", $g_abFilterMaxEagleEnable[$Battle] ? 1 : 0)
	_Ini_Add("search", "DBCheckScatter", $g_abFilterMaxScatterEnable[$Battle] ? 1 : 0)
	_Ini_Add("search", "DBWeakMortar", $g_aiFilterMaxMortarLevel[$Battle])
	_Ini_Add("search", "DBWeakWizTower", $g_aiFilterMaxWizTowerLevel[$Battle])
	_Ini_Add("search", "DBWeakAirDefense", $g_aiFilterMaxAirDefenseLevel[$Battle])
	_Ini_Add("search", "DBWeakXBow", $g_aiFilterMaxXBowLevel[$Battle])
	_Ini_Add("search", "DBWeakInferno", $g_aiFilterMaxInfernoLevel[$Battle])
	_Ini_Add("search", "DBWeakEagle", $g_aiFilterMaxEagleLevel[$Battle])
	_Ini_Add("search", "DBWeakScatter", $g_aiFilterMaxScatterLevel[$Battle])
...
Func SaveConfig_600_28_LB()
	...
	; Search - Start Search If
	_Ini_Add("search", "chkRankedBattleSearchSearches", $g_abSearchSearchesEnable[$RankedBattle] ? 1 : 0)
	_Ini_Add("search", "ABEnableAfterCount", $g_aiSearchSearchesMin[$RankedBattle])
	_Ini_Add("search", "ABEnableBeforeCount", $g_aiSearchSearchesMax[$RankedBattle])
	_Ini_Add("search", "chkRankedBattleSearchCamps", $g_abSearchCampsEnable[$RankedBattle] ? 1 : 0)
	_Ini_Add("search", "ABEnableAfterArmyCamps", $g_aiSearchCampsPct[$RankedBattle])
	_Ini_Add("search", "chkRankedBattleCastleWait", $g_abSearchCastleWaitEnable[$RankedBattle] ? 1 : 0)
	; Search - Filters
	_Ini_Add("search", "ABMeetGE", $g_aiFilterMeetGE[$RankedBattle])
	_Ini_Add("search", "ABsearchGold", $g_aiFilterMinGold[$RankedBattle])
	_Ini_Add("search", "ABsearchElixir", $g_aiFilterMinElixir[$RankedBattle])
	_Ini_Add("search", "ABsearchGoldPlusElixir", $g_aiFilterMinGoldPlusElixir[$RankedBattle])
	_Ini_Add("search", "ABMeetDE", $g_abFilterMeetDEEnable[$RankedBattle] ? 1 : 0)
	_Ini_Add("search", "ABsearchDark", $g_aiFilterMeetDEMin[$RankedBattle])
	_Ini_Add("search", "ABMeetTH", $g_abFilterMeetTH[$RankedBattle] ? 1 : 0)
	_Ini_Add("search", "ABTHLevel", $g_aiFilterMeetTHMin[$RankedBattle])
	_Ini_Add("search", "ABMeetTHO", $g_abFilterMeetTHOutsideEnable[$RankedBattle] ? 1 : 0)
	_Ini_Add("search", "ABCheckMortar", $g_abFilterMaxMortarEnable[$RankedBattle] ? 1 : 0)
	_Ini_Add("search", "ABCheckWizTower", $g_abFilterMaxWizTowerEnable[$RankedBattle] ? 1 : 0)
	_Ini_Add("search", "ABCheckAirDefense", $g_abFilterMaxAirDefenseEnable[$RankedBattle] ? 1 : 0)
	_Ini_Add("search", "ABCheckXBow", $g_abFilterMaxXBowEnable[$RankedBattle] ? 1 : 0)
	_Ini_Add("search", "ABCheckInferno", $g_abFilterMaxInfernoEnable[$RankedBattle] ? 1 : 0)
	_Ini_Add("search", "ABCheckEagle", $g_abFilterMaxEagleEnable[$RankedBattle] ? 1 : 0)
	_Ini_Add("search", "ABCheckScatter", $g_abFilterMaxScatterEnable[$RankedBattle] ? 1 : 0)
	_Ini_Add("search", "ABWeakMortar", $g_aiFilterMaxMortarLevel[$RankedBattle])
	_Ini_Add("search", "ABWeakWizTower", $g_aiFilterMaxWizTowerLevel[$RankedBattle])
	_Ini_Add("search", "ABWeakAirDefense", $g_aiFilterMaxAirDefenseLevel[$RankedBattle])
	_Ini_Add("search", "ABWeakXBow", $g_aiFilterMaxXBowLevel[$RankedBattle])
	_Ini_Add("search", "ABWeakInferno", $g_aiFilterMaxInfernoLevel[$RankedBattle])
	_Ini_Add("search", "ABWeakEagle", $g_aiFilterMaxEagleLevel[$RankedBattle])
	_Ini_Add("search", "ABWeakScatter", $g_aiFilterMaxScatterLevel[$RankedBattle])
	_Ini_Add("search", "ABMeetOne", $g_abFilterMeetOneConditionEnable[$RankedBattle] ? 1 : 0)
...
Func SaveConfig_600_29_DB()
	...
	;_Ini_Add("attack", "DBLightSpell", $g_abAttackUseLightSpell[$Battle] ? 1 : 0)
	;_Ini_Add("attack", "DBHealSpell", $g_abAttackUseHealSpell[$Battle] ? 1 : 0)
	;_Ini_Add("attack", "DBRageSpell", $g_abAttackUseRageSpell[$Battle] ? 1 : 0)
	;_Ini_Add("attack", "DBJumpSpell", $g_abAttackUseJumpSpell[$Battle] ? 1 : 0)
	;_Ini_Add("attack", "DBFreezeSpell", $g_abAttackUseFreezeSpell[$Battle] ? 1 : 0)
	;_Ini_Add("attack", "DBPoisonSpell", $g_abAttackUsePoisonSpell[$Battle] ? 1 : 0)
	;_Ini_Add("attack", "DBEarthquakeSpell", $g_abAttackUseEarthquakeSpell[$Battle] ? 1 : 0)
	;_Ini_Add("attack", "DBHasteSpell", $g_abAttackUseHasteSpell[$Battle] ? 1 : 0)
	;_Ini_Add("attack", "DBCloneSpell", $g_abAttackUseCloneSpell[$Battle] ? 1 : 0)
	;_Ini_Add("attack", "DBInvisibilitySpell", $g_abAttackUseInvisibilitySpell[$Battle] ? 1 : 0)
	;_Ini_Add("attack", "DBRecallSpell", $g_abAttackUseRecallSpell[$Battle] ? 1 : 0)
	;_Ini_Add("attack", "DBSkeletonSpell", $g_abAttackUseSkeletonSpell[$Battle] ? 1 : 0)
	;_Ini_Add("attack", "DBBatSpell", $g_abAttackUseBatSpell[$Battle] ? 1 : 0)
	...
	SaveConfig_600_29_Battle_Scripted()
...
Func SaveConfig_600_29_DB_Standard()
	...
	_Ini_Add("attack", "DBStandardAlgorithm", $g_aiAttackStdDropOrder[$Battle])
	_Ini_Add("attack", "DBDeploy", $g_aiAttackStdDropSides[$Battle])
	_Ini_Add("attack", "DBSmartAttackRedArea", $g_abAttackStdSmartAttack[$Battle] ? 1 : 0)
	_Ini_Add("attack", "DBSmartAttackDeploy", $g_aiAttackStdSmartDeploy[$Battle])
	_Ini_Add("attack", "DBSmartAttackGoldMine", $g_abAttackStdSmartNearCollectors[$Battle][0] ? 1 : 0)
	_Ini_Add("attack", "DBSmartAttackElixirCollector", $g_abAttackStdSmartNearCollectors[$Battle][1] ? 1 : 0)
	_Ini_Add("attack", "DBSmartAttackDarkElixirDrill", $g_abAttackStdSmartNearCollectors[$Battle][2] ? 1 : 0)
EndFunc   ;==>SaveConfig_600_29_DB_Standard

Func SaveConfig_600_29_Battle_Scripted()
...
EndFunc   ;==>SaveConfig_600_29_Battle_Scripted
...
Func SaveConfig_600_29_LB()
	...
	;_Ini_Add("attack", "ABLightSpell", $g_abAttackUseLightSpell[$RankedBattle] ? 1 : 0)
	;_Ini_Add("attack", "ABHealSpell", $g_abAttackUseHealSpell[$RankedBattle] ? 1 : 0)
	;_Ini_Add("attack", "ABRageSpell", $g_abAttackUseRageSpell[$RankedBattle] ? 1 : 0)
	;_Ini_Add("attack", "ABJumpSpell", $g_abAttackUseJumpSpell[$RankedBattle] ? 1 : 0)
	;_Ini_Add("attack", "ABFreezeSpell", $g_abAttackUseFreezeSpell[$RankedBattle] ? 1 : 0)
	;_Ini_Add("attack", "ABCloneSpell", $g_abAttackUseCloneSpell[$RankedBattle] ? 1 : 0)
	;_Ini_Add("attack", "ABInvisibilitySpell", $g_abAttackUseInvisibilitySpell[$RankedBattle] ? 1 : 0)
	;_Ini_Add("attack", "ABRecallSpell", $g_abAttackUseRecallSpell[$RankedBattle] ? 1 : 0)
	;_Ini_Add("attack", "ABPoisonSpell", $g_abAttackUsePoisonSpell[$RankedBattle] ? 1 : 0)
	;_Ini_Add("attack", "ABEarthquakeSpell", $g_abAttackUseEarthquakeSpell[$RankedBattle] ? 1 : 0)
	;_Ini_Add("attack", "ABHasteSpell", $g_abAttackUseHasteSpell[$RankedBattle] ? 1 : 0)
	;_Ini_Add("attack", "ABSkeletonSpell", $g_abAttackUseSkeletonSpell[$RankedBattle] ? 1 : 0)
	;_Ini_Add("attack", "ABBatSpell", $g_abAttackUseBatSpell[$RankedBattle] ? 1 : 0)
...
Func SaveConfig_600_29_LB_Standard()
	...
	_Ini_Add("attack", "LBStandardAlgorithm", $g_aiAttackStdDropOrder[$RankedBattle])
	_Ini_Add("attack", "ABDeploy", $g_aiAttackStdDropSides[$RankedBattle])
	_Ini_Add("attack", "ABSmartAttackRedArea", $g_abAttackStdSmartAttack[$RankedBattle] ? 1 : 0)
	_Ini_Add("attack", "ABSmartAttackDeploy", $g_aiAttackStdSmartDeploy[$RankedBattle])
	_Ini_Add("attack", "ABSmartAttackGoldMine", $g_abAttackStdSmartNearCollectors[$RankedBattle][0] ? 1 : 0)
	_Ini_Add("attack", "ABSmartAttackElixirCollector", $g_abAttackStdSmartNearCollectors[$RankedBattle][1] ? 1 : 0)
	_Ini_Add("attack", "ABSmartAttackDarkElixirDrill", $g_abAttackStdSmartNearCollectors[$RankedBattle][2] ? 1 : 0)
...
Func SaveConfig_600_30_DB()
	...
	_Ini_Add("endbattle", "chkBattleTimeStopAtk", $g_abStopAtkNoLoot1Enable[$Battle] ? 1 : 0)
	_Ini_Add("endbattle", "txtDBTimeStopAtk", $g_aiStopAtkNoLoot1Time[$Battle])
	_Ini_Add("endbattle", "chkBattleTimeStopAtk2", $g_abStopAtkNoLoot2Enable[$Battle] ? 1 : 0)
	_Ini_Add("endbattle", "txtDBTimeStopAtk2", $g_aiStopAtkNoLoot2Time[$Battle])
	_Ini_Add("endbattle", "txtDBMinGoldStopAtk2", $g_aiStopAtkNoLoot2MinGold[$Battle])
	_Ini_Add("endbattle", "txtDBMinElixirStopAtk2", $g_aiStopAtkNoLoot2MinElixir[$Battle])
	_Ini_Add("endbattle", "txtDBMinDarkElixirStopAtk2", $g_aiStopAtkNoLoot2MinDark[$Battle])
	_Ini_Add("endbattle", "chkBattleEndNoResources", $g_abStopAtkNoResources[$Battle] ? 1 : 0)
	_Ini_Add("endbattle", "chkBattleEndOneStar", $g_abStopAtkOneStar[$Battle] ? 1 : 0)
	_Ini_Add("endbattle", "chkBattleEndTwoStars", $g_abStopAtkTwoStars[$Battle] ? 1 : 0)
	_Ini_Add("endbattle", "chkBattlePercentageHigher", $g_abStopAtkPctHigherEnable[$Battle] ? 1 : 0)
	_Ini_Add("endbattle", "txtDBPercentageHigher", $g_aiStopAtkPctHigherAmt[$Battle])
	_Ini_Add("endbattle", "chkBattlePercentageChange", $g_abStopAtkPctNoChangeEnable[$Battle] ? 1 : 0)
	_Ini_Add("endbattle", "txtDBPercentageChange", $g_aiStopAtkPctNoChangeTime[$Battle])
EndFunc   ;==>SaveConfig_600_30_DB

Func SaveConfig_600_30_LB()
	; <><><><> Attack Plan / Search & Attack / Activebase / End Battle <><><><>
	ApplyConfig_600_30_LB(GetApplyConfigSaveAction())
	_Ini_Add("endbattle", "chkRankedBattleTimeStopAtk", $g_abStopAtkNoLoot1Enable[$RankedBattle] ? 1 : 0)
	_Ini_Add("endbattle", "txtABTimeStopAtk", $g_aiStopAtkNoLoot1Time[$RankedBattle])
	_Ini_Add("endbattle", "chkRankedBattleTimeStopAtk2", $g_abStopAtkNoLoot2Enable[$RankedBattle] ? 1 : 0)
	_Ini_Add("endbattle", "txtABTimeStopAtk2", $g_aiStopAtkNoLoot2Time[$RankedBattle])
	_Ini_Add("endbattle", "txtABMinGoldStopAtk2", $g_aiStopAtkNoLoot2MinGold[$RankedBattle])
	_Ini_Add("endbattle", "txtABMinElixirStopAtk2", $g_aiStopAtkNoLoot2MinElixir[$RankedBattle])
	_Ini_Add("endbattle", "txtABMinDarkElixirStopAtk2", $g_aiStopAtkNoLoot2MinDark[$RankedBattle])
	_Ini_Add("endbattle", "chkRankedBattleEndNoResources", $g_abStopAtkNoResources[$RankedBattle] ? 1 : 0)
	_Ini_Add("endbattle", "chkRankedBattleEndOneStar", $g_abStopAtkOneStar[$RankedBattle] ? 1 : 0)
	_Ini_Add("endbattle", "chkRankedBattleEndTwoStars", $g_abStopAtkTwoStars[$RankedBattle] ? 1 : 0)
	...
	_Ini_Add("endbattle", "chkRankedBattlePercentageHigher", $g_abStopAtkPctHigherEnable[$RankedBattle] ? 1 : 0)
	_Ini_Add("endbattle", "txtABPercentageHigher", $g_aiStopAtkPctHigherAmt[$RankedBattle])
	_Ini_Add("endbattle", "chkRankedBattlePercentageChange", $g_abStopAtkPctNoChangeEnable[$RankedBattle] ? 1 : 0)
	_Ini_Add("endbattle", "txtABPercentageChange", $g_aiStopAtkPctNoChangeTime[$RankedBattle])
