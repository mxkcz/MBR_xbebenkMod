...
Func ReadConfig_600_12()
	...
	$g_asTxtDonateTroop[$eTroopSuperYeti] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateSuperYetis", "SYeti|SYetis"), "|", @CRLF)
	...
	$g_asTxtDonateTroop[$eTroopRootRider] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateRootRiders", "root riders|root rider|rootr"), "|", @CRLF)
	$g_asTxtDonateTroop[$eTroopThrower] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateThrowers", "thrower|throwers"), "|", @CRLF)
	$g_asTxtDonateTroop[$eTroopMeteorGolem] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateMeteorGolems", "mgolem|meteor"), "|", @CRLF)
	...
	$g_asTxtDonateTroop[$eTroopSuperHogRider] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateSuperHogRiders", "super hog riders|super hog rider|shogs|shog"), "|", @CRLF)
	...
	$g_asTxtDonateTroop[$eTroopAppWard] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateApprenticeWardens", "apprentice warden|app warden|appward"), "|", @CRLF)
	$g_asTxtDonateTroop[$eTroopDruid] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateDruids", "druid|druids"), "|", @CRLF)
	$g_asTxtDonateTroop[$eTroopFurnace] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateFurnaces", "furnace|furnaces"), "|", @CRLF)
	...
	$g_asTxtDonateSpell[$eSpellRevive] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateReviveSpells", "revive|rev|rv"), "|", @CRLF)
	$g_asTxtDonateSpell[$eSpellTotem] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateTotemSpells", "totem|tspell"), "|", @CRLF)
	$g_asTxtDonateSpell[$eSpellOverGrowth] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateOverGrowthSpells", "overgrowth|og"), "|", @CRLF)
	$g_asTxtDonateSpell[$eSpellIceBlock] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateIceBlockSpells", "iceblock|ib"), "|", @CRLF)
	...
	$g_asTxtDonateTroop[$eTroopCount + $eSiegeTroopLauncher] = StringReplace(IniRead($g_sProfileConfigPath, "donate", "txtDonateTroopL", "Troop Launcher"), "|", @CRLF)
...
Func ReadConfig_600_28_DB()
	...
	IniReadS($g_abSearchCampsEnable[$Battle], $g_sProfileConfigPath, "search", "chkBattleSearchCamps", False, "Bool")
	IniReadS($g_aiSearchCampsPct[$Battle], $g_sProfileConfigPath, "search", "DBEnableAfterArmyCamps", 100, "int")
	...
	; Search - Filters
	IniReadS($g_aiFilterMeetGE[$Battle], $g_sProfileConfigPath, "search", "DBMeetGE", 1, "int")
	...
	IniReadS($g_aiFilterMinGoldPlusElixir[$Battle], $g_sProfileConfigPath, "search", "DBsearchGoldPlusElixir", 160000, "int")
	IniReadS($g_abFilterMeetDEEnable[$Battle], $g_sProfileConfigPath, "search", "DBMeetDE", False, "Bool")
	IniReadS($g_aiFilterMeetDEMin[$Battle], $g_sProfileConfigPath, "search", "DBsearchDark", 0, "int")
	IniReadS($g_abFilterMeetTH[$Battle], $g_sProfileConfigPath, "search", "DBMeetTH", False, "Bool")
	IniReadS($g_aiFilterMeetTHMin[$Battle], $g_sProfileConfigPath, "search", "DBTHLevel", 0, "int")
	IniReadS($g_abFilterMeetTHOutsideEnable[$Battle], $g_sProfileConfigPath, "search", "DBMeetTHO", False, "Bool")
	...
	IniReadS($g_abFilterMaxMortarEnable[$Battle], $g_sProfileConfigPath, "search", "DBCheckMortar", False, "Bool")
	IniReadS($g_abFilterMaxWizTowerEnable[$Battle], $g_sProfileConfigPath, "search", "DBCheckWizTower", False, "Bool")
	IniReadS($g_abFilterMaxAirDefenseEnable[$Battle], $g_sProfileConfigPath, "search", "DBCheckAirDefense", False, "Bool")
	IniReadS($g_abFilterMaxXBowEnable[$Battle], $g_sProfileConfigPath, "search", "DBCheckXBow", False, "Bool")
	IniReadS($g_abFilterMaxInfernoEnable[$Battle], $g_sProfileConfigPath, "search", "DBCheckInferno", False, "Bool")
	IniReadS($g_abFilterMaxEagleEnable[$Battle], $g_sProfileConfigPath, "search", "DBCheckEagle", False, "Bool")
	IniReadS($g_abFilterMaxScatterEnable[$Battle], $g_sProfileConfigPath, "search", "DBCheckScatter", False, "Bool")
	IniReadS($g_aiFilterMaxMortarLevel[$Battle], $g_sProfileConfigPath, "search", "DBWeakMortar", 5, "int")
	IniReadS($g_aiFilterMaxWizTowerLevel[$Battle], $g_sProfileConfigPath, "search", "DBWeakWizTower", 4, "int")
	IniReadS($g_aiFilterMaxAirDefenseLevel[$Battle], $g_sProfileConfigPath, "search", "DBWeakAirDefense", 7, "int")
	IniReadS($g_aiFilterMaxXBowLevel[$Battle], $g_sProfileConfigPath, "search", "DBWeakXBow", 4, "int")
	IniReadS($g_aiFilterMaxInfernoLevel[$Battle], $g_sProfileConfigPath, "search", "DBWeakInferno", 1, "int")
	IniReadS($g_aiFilterMaxEagleLevel[$Battle], $g_sProfileConfigPath, "search", "DBWeakEagle", 2, "int")
	IniReadS($g_aiFilterMaxScatterLevel[$Battle], $g_sProfileConfigPath, "search", "DBWeakScatter", 1, "int")
...
Func ReadConfig_600_28_LB()
	...
	; Search - Start Search If
	IniReadS($g_abSearchSearchesEnable[$RankedBattle], $g_sProfileConfigPath, "search", "chkRankedBattleSearchSearches", False, "Bool")
	IniReadS($g_aiSearchSearchesMin[$RankedBattle], $g_sProfileConfigPath, "search", "ABEnableAfterCount", 1, "int")
	IniReadS($g_aiSearchSearchesMax[$RankedBattle], $g_sProfileConfigPath, "search", "ABEnableBeforeCount", 9999, "int")
	IniReadS($g_abSearchCampsEnable[$RankedBattle], $g_sProfileConfigPath, "search", "chkRankedBattleSearchCamps", False, "Bool")
	IniReadS($g_aiSearchCampsPct[$RankedBattle], $g_sProfileConfigPath, "search", "ABEnableAfterArmyCamps", 100, "int")
	...
	; Search - Filters
	IniReadS($g_aiFilterMeetGE[$RankedBattle], $g_sProfileConfigPath, "search", "ABMeetGE", 2, "int")
	IniReadS($g_aiFilterMinGold[$RankedBattle], $g_sProfileConfigPath, "search", "ABsearchGold", 80000, "int")
	IniReadS($g_aiFilterMinElixir[$RankedBattle], $g_sProfileConfigPath, "search", "ABsearchElixir", 80000, "int")
	IniReadS($g_aiFilterMinGoldPlusElixir[$RankedBattle], $g_sProfileConfigPath, "search", "ABsearchGoldPlusElixir", 160000, "int")
	IniReadS($g_abFilterMeetDEEnable[$RankedBattle], $g_sProfileConfigPath, "search", "ABMeetDE", False, "Bool")
	IniReadS($g_aiFilterMeetDEMin[$RankedBattle], $g_sProfileConfigPath, "search", "ABsearchDark", 0, "int")
	IniReadS($g_abFilterMeetTH[$RankedBattle], $g_sProfileConfigPath, "search", "ABMeetTH", False, "Bool")
	IniReadS($g_aiFilterMeetTHMin[$RankedBattle], $g_sProfileConfigPath, "search", "ABTHLevel", 0, "int")
	IniReadS($g_abFilterMeetTHOutsideEnable[$RankedBattle], $g_sProfileConfigPath, "search", "ABMeetTHO", False, "Bool")
	IniReadS($g_abFilterMaxMortarEnable[$RankedBattle], $g_sProfileConfigPath, "search", "ABCheckMortar", False, "Bool")
	IniReadS($g_abFilterMaxWizTowerEnable[$RankedBattle], $g_sProfileConfigPath, "search", "ABCheckWizTower", False, "Bool")
	IniReadS($g_abFilterMaxAirDefenseEnable[$RankedBattle], $g_sProfileConfigPath, "search", "ABCheckAirDefense", False, "Bool")
	IniReadS($g_abFilterMaxXBowEnable[$RankedBattle], $g_sProfileConfigPath, "search", "ABCheckXBow", False, "Bool")
	IniReadS($g_abFilterMaxInfernoEnable[$RankedBattle], $g_sProfileConfigPath, "search", "ABCheckInferno", False, "Bool")
	IniReadS($g_abFilterMaxEagleEnable[$RankedBattle], $g_sProfileConfigPath, "search", "ABCheckEagle", False, "Bool")
	IniReadS($g_abFilterMaxScatterEnable[$RankedBattle], $g_sProfileConfigPath, "search", "ABCheckScatter", False, "Bool")
	IniReadS($g_aiFilterMaxMortarLevel[$RankedBattle], $g_sProfileConfigPath, "search", "ABWeakMortar", 5, "int")
	IniReadS($g_aiFilterMaxWizTowerLevel[$RankedBattle], $g_sProfileConfigPath, "search", "ABWeakWizTower", 4, "int")
	IniReadS($g_aiFilterMaxAirDefenseLevel[$RankedBattle], $g_sProfileConfigPath, "search", "ABWeakAirDefense", 7, "int")
	IniReadS($g_aiFilterMaxXBowLevel[$RankedBattle], $g_sProfileConfigPath, "search", "ABWeakXBow", 4, "int")
	IniReadS($g_aiFilterMaxInfernoLevel[$RankedBattle], $g_sProfileConfigPath, "search", "ABWeakInferno", 1, "int")
	IniReadS($g_aiFilterMaxEagleLevel[$RankedBattle], $g_sProfileConfigPath, "search", "ABWeakEagle", 2, "int")
	IniReadS($g_aiFilterMaxScatterLevel[$RankedBattle], $g_sProfileConfigPath, "search", "ABWeakScatter", 1, "int")
	IniReadS($g_abFilterMeetOneConditionEnable[$RankedBattle], $g_sProfileConfigPath, "search", "ABMeetOne", False, "Bool")
