...
Func CheckHeroesHealth()
	...
	If $g_bCheckKingPower Or $g_bCheckQueenPower Or $g_bCheckWardenPower Or $g_bCheckChampionPower Or $g_bCheckPrincePower Then
		...
		ElseIf $g_iKingSlot >= 0 And $g_iQueenSlot >= 0 And $g_iWardenSlot >= 0 And $g_iChampionSlot >= 0 And $g_iPrinceSlot >= 0 And ($g_iKingSlot < $g_iTotalAttackSlot - 10 Or $g_iQueenSlot < $g_iTotalAttackSlot - 10 Or $g_iWardenSlot < $g_iTotalAttackSlot - 10 Or $g_iChampionSlot < $g_iTotalAttackSlot - 10 Or $g_iPrinceSlot < $g_iTotalAttackSlot - 10) Then
		...
		If $g_bDraggedAttackBar Then
			...
			$TempPrinceSlot -= $g_iTotalAttackSlot - 10
		EndIf
