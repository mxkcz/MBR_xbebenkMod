...
Func CreateCSVModScriptTab()
	...
	GUICtrlCreateGroup("Ranked Battle Script", $x + $iGroupW + 10, $y, $iGroupW, $iGroupH)
		...
		$g_hLblNotesScriptRankedBattleBattle = GUICtrlCreateLabel("", $x + $iGroupW + 20, $y + 62, $iGroupW - 20, $iGroupH - 72)
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	...
	GUICtrlCreateGroup("Tools", $x, $y, $w, 70)
		...
		$g_hBtnCSVRebuildPrecalc = GUICtrlCreateButton("Rebuild Precalc", $iBtnX + (($iBtnW + $iBtnGap) * 2), $iBtnY, $iBtnW + 15, $iBtnH)
