...
Func ApplyScriptDB()
	...
	If $iApply > 0 Then
		...
		GUICtrlSetState($g_hchkBattleKingAttack, $aiCSVHeros[$eHeroBarbarianKing][0] > 0 ? $GUI_CHECKED : GUICtrlGetState($g_hchkBattleKingAttack))
		GUICtrlSetState($g_hchkBattleQueenAttack, $aiCSVHeros[$eHeroArcherQueen][0] > 0 ? $GUI_CHECKED : GUICtrlGetState($g_hchkBattleQueenAttack))
		GUICtrlSetState($g_hchkBattleWardenAttack, $aiCSVHeros[$eHeroGrandWarden][0] > 0 ? $GUI_CHECKED : GUICtrlGetState($g_hchkBattleWardenAttack))
		GUICtrlSetState($g_hchkBattleChampionAttack, $aiCSVHeros[$eHeroRoyalChampion][0] > 0 ? $GUI_CHECKED : GUICtrlGetState($g_hchkBattleChampionAttack))
		SetLog("CSV 'Attack with' Hero settings applied", $COLOR_SUCCESS)
	EndIf

	If $sCSVCCReq <> "" Then
		GUICtrlSetState($g_hchkBattleDropCC, $GUI_CHECKED)
		SetLog("CSV 'Attack with' CC settings applied", $COLOR_SUCCESS)
	EndIf

	$iApply = 0
	Local $ahchkBattleSpell = StringSplit($g_aGroupAttackBSpell, "#", 2)
...
Func ApplyScriptAB()
	...
	If $iApply > 0 Then
		...
		GUICtrlSetState($g_hchkRankedBattleKingAttack, $aiCSVHeros[$eHeroBarbarianKing][0] > 0 ? $GUI_CHECKED : GUICtrlGetState($g_hchkRankedBattleKingAttack))
		GUICtrlSetState($g_hchkRankedBattleQueenAttack, $aiCSVHeros[$eHeroArcherQueen][0] > 0 ? $GUI_CHECKED : GUICtrlGetState($g_hchkRankedBattleQueenAttack))
		GUICtrlSetState($g_hchkRankedBattleWardenAttack, $aiCSVHeros[$eHeroGrandWarden][0] > 0 ? $GUI_CHECKED : GUICtrlGetState($g_hchkRankedBattleWardenAttack))
		GUICtrlSetState($g_hchkRankedBattleChampionAttack, $aiCSVHeros[$eHeroRoyalChampion][0] > 0 ? $GUI_CHECKED : GUICtrlGetState($g_hchkRankedBattleChampionAttack))
		SetLog("CSV 'Attack with' Hero settings applied", $COLOR_SUCCESS)
	EndIf

	If $sCSVCCReq <> "" Then
		GUICtrlSetState($g_hchkRankedBattleDropCC, $GUI_CHECKED)
		SetLog("CSV 'Attack with' CC settings applied", $COLOR_SUCCESS)
	EndIf
